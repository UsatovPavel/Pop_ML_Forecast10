...
prepare_data:
	$(BIN)/jupyter nbconvert --to notebook --inplace --execute 2.1.collect_cohort_data.ipynb
	$(BIN)/jupyter nbconvert --to notebook --inplace --execute 2.2.collect_more_wb_data.ipynb
	$(BIN)/jupyter nbconvert --to notebook --inplace --execute 2.3.convert_matrix.ipynb
